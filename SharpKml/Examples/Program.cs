...
namespace Examples
{
    class Program
    {
        ...
        private static void LoadKmlFile() {
            KmlFile file = OpenFile("Data/20191114.kml");
            IEnumerable<StyleSelector> styles = file.Styles;
        }
        ...
        private static void CreateSampleData()
        {
            ...
            CopyResource("Examples.Data.20191114.kml", "Data/20191114.kml");
