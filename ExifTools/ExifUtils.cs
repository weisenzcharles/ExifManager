...
namespace ExifTools
{
    ...
    // 
    public class ExifUtils : IDisposable
    {
        ...
        // [altair] 10.09.2003 Created
        // 
        public ExifUtils(System.Drawing.Bitmap Bitmap)
        {
            if (Bitmap == null)
        ...
        // 
        public ExifUtils(string FileName)
        {
        ...
        // [altair] 10.09.2003 Created
        // 
        public string Software => this.GetPropertyString((int)TagNames.SoftwareUsed);
        ...
        public string Title
        {
            get => this.GetPropertyString((int)TagNames.ImageTitle);
            set
            {
                try
                {
