    ...
    public class Preferences
    {
        ...
        public static Preferences Instance
        {
            get
            {
                switch (_instance)
                {
                    case null when File.Exists($"{AppDomain.CurrentDomain.BaseDirectory}\\MagicFile.config.json"):
                        {
                            using Stream stream =
                                File.Open($"{AppDomain.CurrentDomain.BaseDirectory}\\MagicFile.config.json",
                                    FileMode.Open);
